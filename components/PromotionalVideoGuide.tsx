      ...
      <div className="bg-white w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 border-b border-slate-100 flex items-center justify-between bg-white z-10">
          <div>
            ...
            <p className="text-slate-500">A 60-second commercial plan for CabCoat AI</p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div>
                  ...
                  <p className="text-slate-700 leading-relaxed italic">
                    "Stop guessing. Start seeing. Introducing CabCoat AI."
                  </p>
                </div>
                <div>
                   <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">0:20 - The Demo</span>
                  <p className="text-slate-700 leading-relaxed italic">
                    "Just snap a photo of your existing kitchen. In seconds, our AI paints your cabinets with photorealistic precision. Try a trendy Navy, or a classic White."
                  </p>
                </div>
                 <div>
                 ...
                 <div>
                  ...
                  <p className="text-slate-700 leading-relaxed italic">
                    "Design your dream kitchen today. Visit our website and try the CabCoat visualizer for free."
                  </p>
                </div>
              </div>
            </div>
