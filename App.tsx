...
const App: React.FC = () => {
  ...
  const checkAndConnectKey = async () => {
        ...
        <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="group flex items-center gap-2 bg-indigo-50 text-indigo-700 px-5 py-2.5 rounded-full text-xs font-black uppercase tracking-widest border border-indigo-100 hover:bg-indigo-600 hover:text-white transition-all shadow-sm"
            >
